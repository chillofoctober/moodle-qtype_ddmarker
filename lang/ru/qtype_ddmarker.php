...
$string['clearwrongparts'] = 'Переместить неверно размещенные маркеры назад на стартовую позицию по умолчанию под изображением';
...
$string['dropzone'] = 'Целевая зона для перетаскивания {$a}';
$string['dropzoneheader'] = 'Целевые зоны для перетаскивания';
...
$string['formerror_nobgimage'] = 'Вам нужно выбрать изображение для использования как фон для целевой области перетаскивания';
$string['formerror_noitemselected'] = 'Вы определили целевую зону для перетаскивания, но не выбрали маркер, который будет размещаться в этой зоне';
...
$string['infinite'] = 'В несколько зон';
$string['marker'] = 'Маркер';
$string['markers'] = 'Маркеры';
$string['marker_n'] = 'Маркер {no}';
$string['nolabel'] = 'Нет текстовой метки';
$string['pleasedragatleastonemarker'] = 'Ваш ответ не заполнен, вы обязаны разместить как минимум 1 маркер на изображении.';
$string['pluginname'] = 'Перетаскивание маркеров';
$string['pluginname_help'] = 'Выберите файл с фоновым изображением, введите текстовые метки для маркеров и определите целевые зоны для перетаскивания на фоновом изображении, на которые нужно будет перетаскивать ответы.';
...
$string['previewareamessage'] = 'Выберите файл с фоновым изображением, введите текстовые метки для маркеров и определите целевые зоны на фоновом изображении, куда маркеры должны перетаскиваться.<br/> для многоугольника: x1,y1;x2,y2;x3,y3;x4,y4....(где x1, y1 - x,y координаты первой вершины, x2, y2 - x,y координаты второй и т.д. Вам не нужно повторять координаты первой вершины, чтобы сомкнуть многоугольник)<br/> для окружности: x,y;r (где x, y - xy координаты центра окружности и r - радиус)<br/> для прямоугольника: x,y;w,h (где x,y - xy координаты верхнего левого угла прямоугольника и w и h ширина и высота прямоугольника)';
...
$string['summariseplaceno'] = 'Целевая зона для перетаскивания {$a}';
$string['ytop'] = 'Верх';
